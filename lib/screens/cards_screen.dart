...
class _CardsScreenState extends State<CardsScreen> {
  ...
  Widget _cardImage(String path) {
    if (path.trim().isEmpty) {
      return const SizedBox(width: 60, height: 80, child: Icon(Icons.image_not_supported));
    }
    return ClipRRect(
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    trailing: Wrap(
                      spacing: 4,
                      children: [
                        IconButton(icon: const Icon(Icons.edit), onPressed: () => _openAddEdit(card: c)),
                        IconButton(icon: const Icon(Icons.delete), onPressed: () => _deleteCard(c)),
                      ],
                    ),
                  ),
                );
